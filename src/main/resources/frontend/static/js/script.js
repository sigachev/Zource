...
$(function () {
    ...
    var swiperCover = function () {
        $('[data-cover]').each(function () {
            ...
            switch (breakpoint.value) {
                case 'xs':
                    swiperCover.attr('data-xs-height') && swiperCover.css('height', swiperCover.data('xs-height'));
                    break;
                case 'sm':
                    swiperCover.attr('data-sm-height') && swiperCover.css('height', swiperCover.data('sm-height'));
                    break;
                case 'md':
                    swiperCover.attr('data-md-height') && swiperCover.css('height', swiperCover.data('md-height'));
                    break;
                case 'lg':
                    swiperCover.attr('data-lg-height') && swiperCover.css('height', swiperCover.data('lg-height'));
                    break;
                case 'xl':
                    swiperCover.attr('data-xl-height') && swiperCover.css('height', swiperCover.data('xl-height'));
                    break;
            }
        });
    }
    ...
    if ($('.home-slider').length && typeof Swiper !== 'undefined') {
        var homeSlider = new Swiper('.home-slider', {
            loop: true,
            speed: 2000, //SLIDE ROTATION SPEED
            pagination: {
